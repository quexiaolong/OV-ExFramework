...
public interface IIris extends IBase {
    ...
    public static final class Proxy implements IIris {
        ...
        @Override // vendor.pixelworks.hardware.display.V1_0.IIris, com.android.vivoservices.x.android.hidl.base.V1_0.IBase
        ...
        public int irisConfigureSet(int type, ArrayList<Integer> values) throws RemoteException {
            ...
            _hidl_request.writeInterfaceToken(IIris.kInterfaceName);
        ...
        @Override // vendor.pixelworks.hardware.display.V1_0.IIris
        public void irisConfigureGet(int type, ArrayList<Integer> values, irisConfigureGetCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IIris.kInterfaceName);
            _hidl_request.writeInt32(type);
            _hidl_request.writeInt32Vector(values);
            ...
            try {
                ...
                _hidl_request.releaseTemporaryStorage();
                int _hidl_out_result = _hidl_reply.readInt32();
                ArrayList<Integer> _hidl_out_outValues = _hidl_reply.readInt32Vector();
        ...
        @Override // vendor.pixelworks.hardware.display.V1_0.IIris
        public void registerCallback(IIrisCallback callback) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IIris.kInterfaceName);
        ...
        @Override // vendor.pixelworks.hardware.display.V1_0.IIris
        public void panelReadWrite(boolean highSpeed, byte dtype, byte vc, boolean last, ArrayList<Byte> tx, byte rxLen, panelReadWriteCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IIris.kInterfaceName);
            ...
            try {
                ...
                _hidl_request.releaseTemporaryStorage();
                int _hidl_out_result = _hidl_reply.readInt32();
                ArrayList<Byte> _hidl_out_rx = _hidl_reply.readInt8Vector();
        ...
        @Override // vendor.pixelworks.hardware.display.V1_0.IIris
        public void irisConfigureBatch(int type, String json, irisConfigureBatchCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IIris.kInterfaceName);
            _hidl_request.writeInt32(type);
            ...
            try {
                ...
                _hidl_request.releaseTemporaryStorage();
                int _hidl_out_result = _hidl_reply.readInt32();
                String _hidl_out_outJson = _hidl_reply.readString();
    ...
    public static abstract class Stub extends HwBinder implements IIris {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IIris.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{89, -56, 76, -26, 47, Byte.MIN_VALUE, 79, 85, -29, 86, 121, -67, 69, 18, 115, 53, 8, 60, -88, 7, -105, -20, 18, 39, -78, 63, -31, -84, -87, 101, -5, -35}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public IHwInterface queryLocalInterface(String descriptor) {
            if (IIris.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, final HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            switch (_hidl_code) {
                case 1:
                    _hidl_request.enforceInterface(IIris.kInterfaceName);
                    int type = _hidl_request.readInt32();
                    ArrayList<Integer> values = _hidl_request.readInt32Vector();
                ...
                case 2:
                    ...
                    ArrayList<Integer> values2 = _hidl_request.readInt32Vector();
                    irisConfigureGet(type2, values2, new irisConfigureGetCallback() { // from class: vendor.pixelworks.hardware.display.V1_0.IIris.Stub.1
                        @Override // vendor.pixelworks.hardware.display.V1_0.IIris.irisConfigureGetCallback
                        public void onValues(int result, ArrayList<Integer> outValues) {
                            _hidl_reply.writeStatus(0);
                ...
                case 3:
                    _hidl_request.enforceInterface(IIris.kInterfaceName);
                    IIrisCallback callback = IIrisCallback.asInterface(_hidl_request.readStrongBinder());
                ...
                case 4:
                    ...
                    IIrisCallback callback2 = IIrisCallback.asInterface(_hidl_request.readStrongBinder());
                ...
                case 5:
                    ...
                    ArrayList<Byte> tx = _hidl_request.readInt8Vector();
                    byte rxLen = _hidl_request.readInt8();
                    panelReadWrite(highSpeed, dtype, vc, last, tx, rxLen, new panelReadWriteCallback() { // from class: vendor.pixelworks.hardware.display.V1_0.IIris.Stub.2
                        @Override // vendor.pixelworks.hardware.display.V1_0.IIris.panelReadWriteCallback
                        public void onValues(int result, ArrayList<Byte> rx) {
                            _hidl_reply.writeStatus(0);
                            _hidl_reply.writeInt32(result);
                ...
                case 6:
                    ...
                    String json = _hidl_request.readString();
                    irisConfigureBatch(type3, json, new irisConfigureBatchCallback() { // from class: vendor.pixelworks.hardware.display.V1_0.IIris.Stub.3
                        @Override // vendor.pixelworks.hardware.display.V1_0.IIris.irisConfigureBatchCallback
                        public void onValues(int result, String outJson) {
                            _hidl_reply.writeStatus(0);
                            _hidl_reply.writeInt32(result);
