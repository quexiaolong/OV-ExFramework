...
public final class StreamBuffer {
    ...
    public final String toString() {
        return "{.streamId = " + this.streamId + ", .bufferId = " + this.bufferId + ", .buffer = " + this.buffer + ", .status = " + BufferStatus.toString(this.status) + "}";
    }
    ...
    public static final ArrayList<StreamBuffer> readVectorFromParcel(HwParcel parcel) {
        ArrayList<StreamBuffer> _hidl_vec = new ArrayList<>();
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<StreamBuffer> _hidl_vec) {
