...
public final class HalStreamConfiguration {
    public ArrayList<HalStream> streams = new ArrayList<>();

    public final boolean equals(Object otherObject) {
        if (this == otherObject) {
            return true;
        }
        if (otherObject == null || otherObject.getClass() != HalStreamConfiguration.class) {
            return false;
        }
        HalStreamConfiguration other = (HalStreamConfiguration) otherObject;
    ...
    public static final ArrayList<HalStreamConfiguration> readVectorFromParcel(HwParcel parcel) {
        ArrayList<HalStreamConfiguration> _hidl_vec = new ArrayList<>();
        HwBlob _hidl_blob = parcel.readBuffer(16L);
        int _hidl_vec_size = _hidl_blob.getInt32(8L);
        HwBlob childBlob = parcel.readEmbeddedBuffer(_hidl_vec_size * 16, _hidl_blob.handle(), 0L, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            HalStreamConfiguration _hidl_vec_element = new HalStreamConfiguration();
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<HalStreamConfiguration> _hidl_vec) {
        HwBlob _hidl_blob = new HwBlob(16);
