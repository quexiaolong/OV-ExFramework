...
public class ForbiddenItem {
    ...
    public static final int MODE_TAKEBACK_IMMEDIATELY_DISABLE_OVERRIDE = 6;
    public static final int MODE_TAKEBACK_IMMEDIATELY_TIME_IN_MILLIS = 7;
    ...
    private String mode2String(int mode) {
        switch (mode) {
            ...
            case 6:
                return "MODE_TAKEBACK_IMMEDIATELY_DISABLE_OVERRIDE";
            case 7:
                return "MODE_TAKEBACK_IMMEDIATELY_TIME_IN_MILLIS";
            default:
                return "invalid";
        }
    }
