...
public final class ReprocessHalStream {
    public int id = 0;
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != ReprocessHalStream.class) {
            return false;
        }
        ReprocessHalStream other = (ReprocessHalStream) otherObject;
        if (this.id == other.id && this.overrideFormat == other.overrideFormat && this.producerUsage == other.producerUsage && this.consumerUsage == other.consumerUsage && this.maxBuffers == other.maxBuffers) {
            return true;
        }
        return false;
    }
    ...
    public final String toString() {
        return "{.id = " + this.id + ", .overrideFormat = " + PixelFormat.toString(this.overrideFormat) + ", .producerUsage = " + this.producerUsage + ", .consumerUsage = " + this.consumerUsage + ", .maxBuffers = " + this.maxBuffers + "}";
    }
    ...
    public static final ArrayList<ReprocessHalStream> readVectorFromParcel(HwParcel parcel) {
        ArrayList<ReprocessHalStream> _hidl_vec = new ArrayList<>();
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<ReprocessHalStream> _hidl_vec) {
