...
public final class PostProcStream {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != PostProcStream.class) {
            return false;
        }
        PostProcStream other = (PostProcStream) otherObject;
        if (this.streamId == other.streamId && this.streamType == other.streamType && this.width == other.width && this.height == other.height && this.format == other.format && HidlSupport.deepEquals(Long.valueOf(this.usage), Long.valueOf(other.usage)) && HidlSupport.deepEquals(Integer.valueOf(this.dataSpace), Integer.valueOf(other.dataSpace)) && this.rotation == other.rotation && this.groupId == other.groupId && this.physicalCameraId == other.physicalCameraId) {
            return true;
        }
        return false;
    }
    ...
    public final String toString() {
        return "{.streamId = " + this.streamId + ", .streamType = " + StreamType.toString(this.streamType) + ", .width = " + this.width + ", .height = " + this.height + ", .format = " + PixelFormat.toString(this.format) + ", .usage = " + BufferUsage.dumpBitfield(this.usage) + ", .dataSpace = " + Dataspace.dumpBitfield(this.dataSpace) + ", .rotation = " + StreamRotation.toString(this.rotation) + ", .groupId = " + this.groupId + ", .physicalCameraId = " + this.physicalCameraId + "}";
    }
    ...
    public static final ArrayList<PostProcStream> readVectorFromParcel(HwParcel parcel) {
        ArrayList<PostProcStream> _hidl_vec = new ArrayList<>();
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<PostProcStream> _hidl_vec) {
