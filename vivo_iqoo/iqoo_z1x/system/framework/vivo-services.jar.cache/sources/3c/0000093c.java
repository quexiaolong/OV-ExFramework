...
public final class ReprocessRequest {
    public int frameNumber = 0;
    public ArrayList<Byte> settings = new ArrayList<>();
    public ReprocessStreamBuffer inputBuffer = new ReprocessStreamBuffer();
    public ArrayList<ReprocessStreamBuffer> outputBuffers = new ArrayList<>();
    ...
    public static final ArrayList<ReprocessRequest> readVectorFromParcel(HwParcel parcel) {
        ArrayList<ReprocessRequest> _hidl_vec = new ArrayList<>();
        HwBlob _hidl_blob = parcel.readBuffer(16L);
        int _hidl_vec_size = _hidl_blob.getInt32(8L);
        HwBlob childBlob = parcel.readEmbeddedBuffer(_hidl_vec_size * 80, _hidl_blob.handle(), 0L, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ReprocessRequest _hidl_vec_element = new ReprocessRequest();
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<ReprocessRequest> _hidl_vec) {
