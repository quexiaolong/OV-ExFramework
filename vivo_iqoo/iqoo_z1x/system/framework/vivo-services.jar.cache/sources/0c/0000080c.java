...
public final class VivoPermissionDeniedDialogModeOne {
    ...
    public VivoPermissionDeniedDialogModeOne(VivoPermissionService vps, Context context, Handler uiHandler, String packageName, String permName, int uid, String key) {
        this.mVPS = null;
        this.mContext = null;
    ...
    private String getContentStr() {
        ...
        if (osVer >= 3.0f) {
            return String.format(this.mContext.getString(51249437), getAppName(packageName), PermStr);
        }
        return String.format(this.mContext.getString(51249436), getAppName(packageName), PermStr);
    }
    ...
    public void show() {
        ...
        AlertDialog create = new AlertDialog.Builder(this.mContext, VivoThemeUtil.getSystemThemeStyle(VivoThemeUtil.ThemeType.DIALOG_ALERT)).setTitle(contentTitle).setView(layout).setPositiveButton(51249452, listener).setNegativeButton(51249418, listener).create();
    ...
    /* renamed from: com.vivo.services.security.server.VivoPermissionDeniedDialogModeOne$1  reason: invalid class name */
    /* loaded from: classes.dex */
    ...
    public final class ConfirmDialogListener implements DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            VivoPermissionType.getVPType(VivoPermissionDeniedDialogModeOne.this.mPermissionName).getVPTypeId();
            if (VivoPermissionDeniedDialogModeOne.this.mVPS.checkConfigDeniedMode(VivoPermissionDeniedDialogModeOne.this.mPackageName, VivoPermissionDeniedDialogModeOne.this.mPermissionName) == 48) {
                VivoPermissionDeniedDialogModeOne.this.mVPS.setConfigDeniedMode(VivoPermissionDeniedDialogModeOne.this.mPackageName, VivoPermissionDeniedDialogModeOne.this.mPermissionName, 80, VivoPermissionDeniedDialogModeOne.this.mCallingUid);
            }
            if (which == -1) {
    ...
    public final class ConfirmTimerTask extends TimerTask {
        ...
        private boolean needDismiss() {
            ...
            return superSaverOn || VivoPermissionService.isKeyguardLocked(VivoPermissionDeniedDialogModeOne.this.mContext);
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void startSettingPermissionActivity() {
        ...
        if (isPermissionManagerAppExisted()) {
            ...
            componetName = new ComponentName(VivoAppIsolationController.NOTIFY_IQOO_SECURE_PACKAGE, "com.iqoo.secure.safeguard.SoftPermissionDetailActivity");
        }
        try {
