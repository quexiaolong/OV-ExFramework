...
public class ProcessList {
    ...
    public static final int CONTENT_PROVIDER_RETAIN_TIME = 20000;
    ...
    public static final int LASTEST_PREVIOUS_APP_ADJ = 481;
    public static final int LASTEST_PREVIOUS_APP_MAX = 482;
    ...
    public static final int PROTECT_ACTIVITY_ADJ = 451;
    public static final int PROTECT_GAME_ADJ = 452;
    public static final int PROTECT_SERVICE_ADJ = 450;
    ...
    public static final int VERY_LASTEST_PREVIOUS_APP_ADJ = 430;
