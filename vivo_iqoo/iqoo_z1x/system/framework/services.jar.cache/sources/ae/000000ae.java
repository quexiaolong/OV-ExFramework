...
public final class ContextHub {
    ...
    public String f0vendor = new String();
    ...
    public static final ArrayList<ContextHub> readVectorFromParcel(HwParcel parcel) {
        ...
        HwBlob childBlob = parcel.readEmbeddedBuffer(_hidl_vec_size * IVivoRatioControllerUtils.NAVI_HEIGHT_1080P, _hidl_blob.handle(), 0L, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ContextHub _hidl_vec_element = new ContextHub();
            _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * IVivoRatioControllerUtils.NAVI_HEIGHT_1080P);
    ...
    public final void writeToParcel(HwParcel parcel) {
        HwBlob _hidl_blob = new HwBlob((int) IVivoRatioControllerUtils.NAVI_HEIGHT_1080P);
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<ContextHub> _hidl_vec) {
        ...
        HwBlob childBlob = new HwBlob(_hidl_vec_size * IVivoRatioControllerUtils.NAVI_HEIGHT_1080P);
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            _hidl_vec.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, _hidl_index_0 * IVivoRatioControllerUtils.NAVI_HEIGHT_1080P);
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_blob.putString(16 + _hidl_offset, this.f0vendor);
