...
public final class ProgramListChunk {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        HwBlob childBlob = parcel.readEmbeddedBuffer(_hidl_vec_size * IVivoRatioControllerUtils.NAVI_HEIGHT_1080P, _hidl_blob.handle(), _hidl_offset + 8 + 0, true);
        this.modified.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            this.modified.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, _hidl_index_0 * IVivoRatioControllerUtils.NAVI_HEIGHT_1080P);
        }
