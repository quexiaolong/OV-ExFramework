...
public abstract class BrightnessMappingStrategy {
    ...
    public static BrightnessMappingStrategy create(Resources resources) {
        ...
        float[] nitsRange = getFloatArray(resources.obtainTypedArray(17236072));
        int[] backlightRange = resources.getIntArray(17236071);
        long shortTermModelTimeout = resources.getInteger(17694744);
        if (isValidMapping(nitsRange, backlightRange) && isValidMapping(luxLevels, brightnessLevelsNits)) {
            int minimumBacklight = resources.getInteger(17694894);
            int maximumBacklight = resources.getInteger(17694893);
    ...
    protected static float normalizeAbsoluteBrightness(int brightness) {
        return BrightnessSynchronizer.brightnessIntToFloat(brightness, 1, 255, 0.0f, 1.0f);
    }
    ...
    private static class SimpleMappingStrategy extends BrightnessMappingStrategy {
        ...
        private SimpleMappingStrategy(float[] lux, int[] brightness, float maxGamma, long timeout) {
            ...
            Preconditions.checkArrayElementsInRange(brightness, 0, (int) IVivoRmsInjector.QUIET_TYPE_ALL, "brightness");
