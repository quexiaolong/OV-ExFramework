...
final class Constants {
    ...
    static final String PLAYBACK_DEVICE_ACTION_ON_ROUTING_CONTROL = "ro.hdmi.cec.source.playback_device_action_on_routing_control";
    static final String PLAYBACK_DEVICE_ACTION_ON_ROUTING_CONTROL_NONE = "none";
    static final String PLAYBACK_DEVICE_ACTION_ON_ROUTING_CONTROL_WAKE_UP_AND_SEND_ACTIVE_SOURCE = "wake_up_and_send_active_source";
    ...
    static final String POWER_STATE_CHANGE_ON_ACTIVE_SOURCE_LOST = "ro.hdmi.cec.source.power_state_change_on_active_source_lost";
