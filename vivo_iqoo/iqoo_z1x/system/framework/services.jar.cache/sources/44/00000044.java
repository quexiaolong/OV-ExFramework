...
public final class AudioPortDeviceExt {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != AudioPortDeviceExt.class) {
            return false;
        }
        AudioPortDeviceExt other = (AudioPortDeviceExt) otherObject;
    ...
    public static final ArrayList<AudioPortDeviceExt> readVectorFromParcel(HwParcel parcel) {
        ArrayList<AudioPortDeviceExt> _hidl_vec = new ArrayList<>();
        HwBlob _hidl_blob = parcel.readBuffer(16L);
        int _hidl_vec_size = _hidl_blob.getInt32(8L);
        HwBlob childBlob = parcel.readEmbeddedBuffer(_hidl_vec_size * 40, _hidl_blob.handle(), 0L, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            AudioPortDeviceExt _hidl_vec_element = new AudioPortDeviceExt();
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<AudioPortDeviceExt> _hidl_vec) {
