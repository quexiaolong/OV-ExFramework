...
public final class UsbStrings {
    ...
    private static void initDescriptorNames() {
        ...
        sDescriptorNames.put(Byte.valueOf((byte) UsbDescriptor.DESCRIPTORTYPE_CLASSSPECIFIC_INTERFACE), "Class-specific Interface");
        sDescriptorNames.put(Byte.valueOf((byte) UsbDescriptor.DESCRIPTORTYPE_CLASSSPECIFIC_ENDPOINT), "Class-specific Endpoint");
    ...
    private static void initTerminalNames() {
        ...
        hashMap.put(Integer.valueOf((int) UsbTerminalTypes.TERMINAL_USB_STREAMING), "USB Streaming");
