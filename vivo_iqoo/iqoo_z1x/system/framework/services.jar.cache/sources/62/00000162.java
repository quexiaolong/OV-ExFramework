...
public final class ModelParameterRange {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != ModelParameterRange.class) {
            return false;
        }
        ModelParameterRange other = (ModelParameterRange) otherObject;
    ...
    public static final ArrayList<ModelParameterRange> readVectorFromParcel(HwParcel parcel) {
        ArrayList<ModelParameterRange> _hidl_vec = new ArrayList<>();
        HwBlob _hidl_blob = parcel.readBuffer(16L);
        int _hidl_vec_size = _hidl_blob.getInt32(8L);
        HwBlob childBlob = parcel.readEmbeddedBuffer(_hidl_vec_size * 8, _hidl_blob.handle(), 0L, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ModelParameterRange _hidl_vec_element = new ModelParameterRange();
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<ModelParameterRange> _hidl_vec) {
