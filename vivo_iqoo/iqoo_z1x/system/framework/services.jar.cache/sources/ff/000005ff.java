...
public class MotionEventInjector extends BaseEventStreamTransformation implements Handler.Callback {
    ...
    public void injectEvents(List<GestureDescription.GestureStep> gestureSteps, IAccessibilityServiceClient serviceInterface, int sequence, int displayId) {
    ...
    public boolean handleMessage(Message message) {
        if (message.what == 2) {
            ...
            injectEventsMainThread((List) args.arg1, (IAccessibilityServiceClient) args.arg2, args.argi1, args.argi2);
            args.recycle();
            return true;
    ...
    private void injectEventsMainThread(List<GestureDescription.GestureStep> gestureSteps, IAccessibilityServiceClient serviceInterface, int sequence, int displayId) {
